...
for (let x = 0; x < starWarsCharacters.length; x++) {
  if (starWarsCharacters[x].gender == "female") {
    femaleCharacters.
    push({name:starWarsCharacters[x].name, hair_color:starWarsCharacters[x].hair_color, eye_color:starWarsCharacters[x].eye_color})
  }
}
  ...
  for (let x = 0; x < starWarsCharacters.length; x++) {
    switch (starWarsCharacters[x].eye_color) {
      ...
      case 'red' :
        ...
        break;
      case 'blue-gray' : 
        eyeColor['blue-gray'].push(starWarsCharacters[x]);
        break;
    }
  }
  
  console.log(eyeColor);
  console.log(`Primo nome personaggio -- ${eyeColor.blue[0].name}`);
...
newArray = starWarsCharacters.map(function(y) {
  if (y.gender == "n/a") {
    y.gender = "robot";
    return y;
  }
