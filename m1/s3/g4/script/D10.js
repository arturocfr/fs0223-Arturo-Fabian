...
console.log(`somma delle variabile è pari a ${sum} `);
...
console.log(`Il numero maggiore è: ${whoIsBigger(23,44)}`);
...
console.log(`La stringa è: ${deleteOne("ciao", true)}`);
...
console.log(`${onlyLetters("B3ll4 C1a0")}`);
...
console.log(`${isThisAnEmail("email@hotmail.com")}`);
...
console.log(`Is today myBirthday? ${isTodayMyBirthday(4, 8)}`);
// Arrays & Oggetti
...
console.log(`Film nell'array pari a: ${countMovies()}`);
...
console.log(`Somma di tutti gli anni in cui sono stati prodotti i film contenuti nell'array è: ${sumAllTheYears()}`);
/* ESERCIZIO 17
...
console.log("Un'array contenete film con la parola lord:");
